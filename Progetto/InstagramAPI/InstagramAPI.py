...
class InstagramAPI:
    ...
    DEVICE_SETTINTS = {'manufacturer': 'Xiaomi',
                       ...
                       'android_version': 18,
                       'android_release': '4.3'}
    # USER_AGENT = 'Instagram 10.34.0 Android ({android_version}/{android_release}; 320dpi; 720x1280; {manufacturer}; {model}; armani; qcom; en_US)'.format(**DEVICE_SETTINTS)
    ...
    def generateDeviceId(self, seed):
        ...
        return 'hmac.AR3VKJ5I0qAju8MWWDjqofPGGDxz5bpv_yfJK8xyYMEDoSl_'
